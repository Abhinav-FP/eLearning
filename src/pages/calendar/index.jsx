...
const Index = ({ Availability, setIsPopupOpen, usedInPopup, setSelectedSlot, selectedLesson, mergedAvailability, teacherData, studentTimeZone, setStudentTimeZone }) => {
  ...
  return (
    <div className="w-full ">
      <div className="bg-white rounded-[20px]  border-[#25790b80] border-1">
          ...
          {!usedInPopup &&
            <div className="flex  gap-2 text-base lg:text-lg font-semibold text-[#1E1E1E] m-0 tracking-[-0.03em] w-full md:w-auto">
              <button
                ...
                className={
                  "font-medium cursor-pointer rounded-full py-1.5 lg:py-3.5 px-3 sm:px-5 text-[#ffffff] bg-[#55844D] hover:bg-[#3d5e37] text-sm sm:text-base md:w-full"
                }
              >
                Message
              </button>
        ...
        <div className="p-4 relative">
          ...
          <div className="mt-4 relative flex justify-center sm:justify-end">
            <select
              className="w-fit lg:px-2 py-2 text-xs sm:text-sm border border-[#55844D] rounded-[6px] lg:rounded-[10px] bg-white text-[#55844D] focus:outline-none focus:ring-1 focus:ring-[#55844D]"
