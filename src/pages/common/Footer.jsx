...
export default function Footer() {
     return (
        <>
          <footer className="bg-[#55844D] pt-[50px] md:pt-[60px] lg:pt-[90px] pb-[15px] md:pb-[20px]">
                  ...
                  <div className="flex flex-wrap -mx-4 justify-between text-center md:text-left">
                     ...
                     <div className="w-full md:w-[324px] px-4 text-center md:text-left">
                        ...
                        <ul className="space-y-1">
                           <li>
                              <Link href="/" className="-tracking-[0.03em] text-base text-white hover:underline">Home</Link>
                           </li>
                           <li>
                              <Link href="/find-teacher" className="-tracking-[0.03em] text-base text-white hover:underline">Find a Teacher</Link>
                           </li>
                           <li>
                              <Link href="/#howitwork" className="-tracking-[0.03em] text-base text-white hover:underline">How It Works</Link>
                           </li>
                           <li>
                              <Link href="/#faq" className="-tracking-[0.03em] text-base text-white hover:underline">FAQ</Link>
                           </li>
                           <li>
                     ...
                     <div className="w-full md:w-[324px] px-4 ">
                        <ul className="space-y-1">
                           <li>
                              <Link href="/term-conditions" className="-tracking-[0.03em] text-base text-white hover:underline " >Terms & condition</Link>
                           </li>
                           <li>
                              <Link href="/privacy-policy" className="-tracking-[0.03em] text-base text-white hover:underline" >Privacy Policy</Link>
                           </li> 
                        </ul>
                     </div>
                  </div>
