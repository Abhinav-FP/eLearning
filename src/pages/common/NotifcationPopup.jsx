...
export default function NotificationPopup() {
    ...
    return (
        <div className="relative">
            <div>
                <div
                    className="border border-[rgba(0,0,0,0.1)] rounded-md lg:rounded-xl w-[44px] lg:w-[48px] h-[34px] lg:h-[38px] flex items-center justify-center text-[#55844D] bg-[rgba(204,40,40,0.1)] hover:bg-[#55844D] hover:text-white cursor-pointer"
                ...
                {Record != "0" && (
                    <span className="absolute top-0 right-0 transform translate-x-2 -translate-y-2 bg-green-500 text-white text-xs font-bold w-5 h-5 flex items-center justify-center rounded-full">
                        {Record}
                    </span>
                )}
                {/* {isPopupOpen && (
                    <div className="absolute top-12 -right-12 md:right-0 w-[270px] md:w-[300px] bg-white shadow-lg rounded-xl p-4 z-10">
                        ...
                        <div>
                            {loading ? (
                                ...
                                <p className="text-green-500 text-sm">{error}</p>
