                    ...
                    <div className=" flex flex-col lg:flex-row justify-between items-center -mx-4">
                        <div className="w-full lg:w-7/12 px-4 ">
                            <div className="flex flex-col gap-[44px] lg:pr-[50px] ">
                                ...
                                <div className="w-fulk flex justify-end relative">
                                    ...
                                    <div className="border-[10px] border-[#55844D] w-[66px] h-[66px] absolute left-5 -top-5 rounded-full"></div>
                        ...
                        <div className="w-full lg:w-5/12 px-4 mt-8 lg:mt-0 text-center lg:text-left">
                            ...
                            <div className="w-full flex justify-center lg:justify-start">
                                <Link
                                    href="/#lesson"
                                    className="text-center font-medium cursor-pointer rounded-full py-2.5 px-4 bg-[#55844D] hover:bg-[#3d5e37] text-base lg:text-lg xl:text-xl lg:py-3 xl:py-3.5 text-white max-w-[438px] w-full"
                                >
                                    Book a lesson
                                </Link>
                            </div>
