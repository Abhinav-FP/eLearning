    ...
    return (
        <>
         <div className="ready-bg py-[60px] md:py-[100px] lg:py-[127px]">
             <div className="mx-auto container sm:container md:container lg:max-w-[1230px] px-4 text-center">
                <Heading classess={'text-white mb-[30px] lg:mb-[35px]'} title="Ready to Start Learning?" />
