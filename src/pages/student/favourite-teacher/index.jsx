        ...
        <div className="space-y-4">
          {loading ? (
            ...
            teachers?.map((teacher, idx) => (
              <Link href={`/teacher/${teacher?._id}`} className="block group" key={idx}>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap  gap-x-2 md:gap-x-6 lg:gap-x-8 mb-3 lg:mb-5">
                        <div>
                          ...
                          <span className="capitalize text-black text-sm -tracking-[0.03em] ">{teacher?.teacher?.languages_spoken.join(' , ') || "N/A"}</span>
                        </div>
                        <div>
                          <span className="text-[#8D929A] text-sm -tracking-[0.03em] pr-2">Nationality :</span>
                          <span className="capitalize text-black text-sm -tracking-[0.03em] ">{teacher?.teacher?.userId?.nationality || "N/A"}</span>
                        </div>
                        {/* {item?.userId?.nationality} */}
                        <div>
                          <span className="text-[#8D929A] text-sm -tracking-[0.03em] pr-2">Gender :</span>
                          <span className="capitalize text-black text-sm -tracking-[0.03em] ">{teacher?.teacher?.gender === 'M' ? 'Male' : teacher?.teacher?.gender === 'F' ? 'Female' : "N/A"}</span>
                        </div>
                        <div>
                          <span className="text-[#8D929A] text-sm -tracking-[0.03em] pr-2">Experience :</span>
                          <span className="text-black text-sm -tracking-[0.03em] ">{teacher?.teacher?.experience || 'N/a'} Years</span>
                        </div>
                      </div>
