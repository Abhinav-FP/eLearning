    ...
    <StudentLayout>
      ...
      <div className="flex flex-wrap gap-6 mb-6">
        <div className="bg-white rounded-2xl shadow px-6 pt-6 w-full md:w-[48%] border-red-100 border-1">
          <h2 className="text-lg font-semibold text-[#CC2828] mb-4">Upcoming Lessons</h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 w-full md:w-[48%] border-red-100 border-1">
          <h2 className="text-lg font-semibold text-[#CC2828] mb-4">Favorite Teachers</h2>
      ...
      <div className="flex flex-wrap gap-6">
        <div className="bg-white rounded-2xl shadow p-6 w-full md:w-[48%] border-red-100 border-1">
          <h2 className="text-lg font-semibold text-[#CC2828] mb-4">Recent Reviews</h2>
          <div className="space-y-4">
            {[1, 2, 3].map((_, idx) => (
              <div
                key={idx}
