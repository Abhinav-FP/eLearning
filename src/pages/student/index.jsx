          ...
          <div className='w-full lg:w-1/2 px-4'>
            <div className="bg-white p-4 lg:p-5 border border-[rgba(204,40,40,0.2)] dashboard-box rounded-[20px]">
              ...
              <div className="space-y-3">
                ...
                <p className='text-[#565F66] text-base lg:text-lg font-normal flex flex-wrap'><span className='font-medium min-w-[100px]  lg:min-w-[128px]'>Day :</span> {moment(dashboard?.booking?.startDateTime).format('dddd')}</p>
