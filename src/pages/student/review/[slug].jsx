                ...
                <div className="mb-10">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-xl border border-gray-200">
                      ...
                      <div className="flex justify-center gap-3">
                        {[1, 2, 3].map((star) => (
                          <button
                            ...
                            className={`hover:scale-110 transition ${star <= rating ? 'text-yellow-400' : 'text-gray-300'
                              }`}
                          >
                    ...
                    <button
                      type="submit"
                      disabled={processing}
                      className="w-full bg-[#CC2828] hover:bg-red-700 text-white py-3 rounded-lg text-lg font-medium transition disabled:opacity-50"
                    >
