...
export default function SpecialSlotCancel({ data, fetchEarnings }) {
  ...
  const handleCancel = async (id) => {
    ...
    try {
      ...
      const response = await main.SpecialSlotCancel(id);
        ...
        >
          <div className="px-6 text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">
              Are you sure you want to cancel this slot? <br />
