        ...
        <div className="flex flex-col md:flex-row justify-between md:items-center mb-4 lg:mb-5">
          ...
          <div className="flex items-center justify-between space-x-3">
            ...
            <button
              ...
              className="w-fit px-2 sm:px-8 py-2.5 hover:bg-white hover:text-[#55844D] border border-[#55844D] rounded-md h-[42px] tracking-[-0.06em] text-sm font-medium bg-[#55844D] text-white cursor-pointer"
            >
              Add Special Slot
            </button>
          </div>
        ...
        <div className="rounded-[5px] border border-[rgba(19,101,16,0.3)] overflow-x-auto">
          <table className="min-w-full text-sm text-center rounded-[20px]">
            <thead className="bg-[rgba(38,185,27,0.1)] text-[#535353] tracking-[-0.04em] font-inter rounded-[20px] whitespace-nowrap">
              <tr>
                <th className="font-normal text-sm lg:text-base px-3 lg:px-4 py-2 lg:py-3 border-t border-[rgba(40,204,43,0.3)] capitalize">
                  Index
                </th>
                <th className="font-normal text-sm lg:text-base px-3 lg:px-4 py-2 lg:py-3 border-t border-[rgba(40,204,43,0.3)] capitalize">
                  Lesson Name
              ...
              <tbody>
                {payout && payout?.length > 0 ? (
                  payout?.map((item, index) => (
                    <tr
                      key={index}
                      className="hover:bg-[rgba(38,185,27,0.1)] border-t border-[rgba(40,204,43,0.3)]"
                    >
                      ...
                      <td className="capitalize px-3 lg:px-4 py-2 lg:py-3 text-black text-sm lg:text-base font-medium font-inter ">
                        {item?.cancelled
                          ...
                          ? "N/A"
                          : item?.amount == 0 || item?.paymentStatus === "pending"
