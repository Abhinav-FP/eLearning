...
export default function LessonList() {
    const data = [
       {
        title: "Trial Lessons",
        decription: "Introduction & Goal Setting, Brief Language Assessment, Personalized Feedback & Next Steps",
        price: "25.00"
       },
       {
        title: "General English Lessons",
        decription: "Grammar, Vocabulary & Pronunciation, Reading, Writing & Listening Practice",
        price: "25.00"
       },
       {
        title: "Business English",
        decription: "Introduction & Goal Setting, Introduction & Goal Setting",
        price: "30.00"
       },
       {
        title: "Trial Lessons",
                            ...
                            <li key={index} className="bg-white rounded-[10px] lg:rounded-[20px] p-5 lg:p-6 xl:p-10 ">
                                ...
                                <div className="flex flex-wrap ">
                                    ...
                                    <div className="w-full md:w-[170px]  md:text-right">
                                        <button className="text-center inline-block bg-[rgba(204,40,40,0.1)] tracking-[-0.04em] text-[#CC2828] text-base xl:text-lg font-semibold font-inter block px-4 lg:px-5 lg:px-6 py-2.5 rounded-full ">USD ${item?.price}</button>
                                    </div>
                                </div>
                            </li>
                        )
