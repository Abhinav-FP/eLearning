        ...
        <div className="border-t border-[#CC2828] pt-4">
          <div className="flex justify-between">
            ...
            <p className="font-medium">
              {formatMultiPrice((selectedLesson?.price*multipleLessons) + (commission * selectedLesson?.price * multipleLessons), "USD")}
            </p>
          </div>
          <p className="text-sm text-gray-500">{`Included processing fee of ${formatMultiPrice(commission * selectedLesson?.price * multipleLessons, "USD")}`}</p>
...
export default MultipleLessonPayment;