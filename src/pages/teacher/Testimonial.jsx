...
export default function Testimonial({ reviews }) {
    ...
    return (
        <div className="pt-[20px] lg:pt-[40px] xl:pt-[60px] pb-[40px] lg:pb-[60px] bg-[#F8F9FA] review">
              ...
              <>
                <p className="text-[#4E4E4E] tracking-[-0.04em] text-base mb-6 text-center lg:mb-10">
                        ...
                        {reviews.map((item, index) => (
                            <SwiperSlide key={index}>
                                <div className="border h-full border-[rgba(56,121,117,0.2)] rounded-[20px] p-[30px] lg:p-[40px]">
                                    ...
                                    <h3 className="text-black text-center -tracking-[0.03em] text-base font-semibold mb-3">
                                        {item?.userId?.name}
                                    </h3>
                                    <div className="flex text-[#E4B750] text-sm justify-center mb-4">
                                        <StarRating rating={item?.rating} />
                                    </div>
                                    <p className="text-[#535353] font-medium italic text-base text-center">
                                        {item?.description}
                                    </p>
                                </div>
                            </SwiperSlide>
